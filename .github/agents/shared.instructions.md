---
description: "Shared rules for all agents in the Microsoft Fabric to Gateway migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Microsoft Fabric to Gateway Migration
